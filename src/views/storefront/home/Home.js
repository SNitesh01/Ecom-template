          ...
          <Row className="g-2 mb-2">
            <Col sm="6" md="8">
              <Card className="sh-30 sh-sm-45 hover-img-scale-up">
                <img src="/img/banner/cta-standard-1.jpg" className="card-img h-100 scale" alt="card image" />
            ...
            <Col sm="6" md="4">
              <Card className="sh-30 sh-sm-45 hover-img-scale-up">
                <img src="/img/banner/cta-vertical-3.jpg" className="card-img h-100 scale" alt="card image" />
                <div className="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
