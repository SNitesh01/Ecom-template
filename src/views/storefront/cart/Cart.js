          ...
          <div className="mb-5">
            <Card className="mb-2">
              <Row className="g-0 sh-18 sh-md-14">
                <Col xs="auto">
                  <img src="/img/product/small/product-1.jpg" className="card-img card-img-horizontal h-100 sw-9 sw-sm-13 sw-md-15" alt="thumb" />
                </Col>
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-18 sh-md-14">
                <Col xs="auto">
                  <img src="/img/product/small/product-2.jpg" className="card-img card-img-horizontal h-100 sw-9 sw-sm-13 sw-md-15" alt="thumb" />
                </Col>
                <Col className="position-relative h-100">
                  <Card.Body>
                    <Row className="h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-18 sh-md-14">
                <Col xs="auto">
                  <img src="/img/product/small/product-3.jpg" className="card-img card-img-horizontal h-100 sw-9 sw-sm-13 sw-md-15" alt="thumb" />
                </Col>
                <Col className="position-relative h-100">
                  <Card.Body>
                    <Row className="h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-18 sh-md-14">
                <Col xs="auto">
                  <img src="/img/product/small/product-4.jpg" className="card-img card-img-horizontal h-100 sw-9 sw-sm-13 sw-md-15" alt="thumb" />
                </Col>
                <Col className="position-relative h-100">
                  <Card.Body>
                    <Row className="h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-18 sh-md-14">
                <Col xs="auto">
                  <img src="/img/product/small/product-5.jpg" className="card-img card-img-horizontal h-100 sw-9 sw-sm-13 sw-md-15" alt="thumb" />
                </Col>
                <Col className="position-relative h-100">
                  <Card.Body>
                    <Row className="h-100">
