            ...
            <Card.Body>
              <div className="mb-5">
                <Row className="g-0 sh-9 mb-3">
                  <Col xs="auto">
                    <img src="/img/product/small/product-1.jpg" className="card-img rounded-md h-100 sw-13" alt="thumb" />
                  </Col>
                  <Col>
                ...
                <Row className="g-0 sh-9 mb-3">
                  <Col xs="auto">
                    <img src="/img/product/small/product-2.jpg" className="card-img rounded-md h-100 sw-13" alt="thumb" />
                  </Col>
                  <Col>
                    <div className="ps-4 pt-0 pb-0 pe-0 h-100">
                      <Row className="g-0 h-100 align-items-start align-content-center">
                ...
                <Row className="g-0 sh-9 mb-3">
                  <Col xs="auto">
                    <img src="/img/product/small/product-3.jpg" className="card-img rounded-md h-100 sw-13" alt="thumb" />
                  </Col>
                  <Col>
                    <div className="ps-4 pt-0 pb-0 pe-0 h-100">
                      <Row className="g-0 h-100 align-items-start align-content-center">
                ...
                <Row className="g-0 sh-9 mb-3">
                  <Col xs="auto">
                    <img src="/img/product/small/product-4.jpg" className="card-img rounded-md h-100 sw-13" alt="thumb" />
                  </Col>
                  <Col>
                    <div className="ps-4 pt-0 pb-0 pe-0 h-100">
                      <Row className="g-0 h-100 align-items-start align-content-center">
                ...
                <Row className="g-0 sh-9 mb-3">
                  <Col xs="auto">
                    <img src="/img/product/small/product-5.jpg" className="card-img rounded-md h-100 sw-13" alt="thumb" />
                  </Col>
                  <Col>
                    <div className="ps-4 pt-0 pb-0 pe-0 h-100">
                      <Row className="g-0 h-100 align-items-start align-content-center">
                ...
                <Row className="g-0 sh-9 mb-3">
                  <Col xs="auto">
                    <img src="/img/product/small/product-6.jpg" className="card-img rounded-md h-100 sw-13" alt="thumb" />
                  </Col>
                  <Col>
                    <div className="ps-4 pt-0 pb-0 pe-0 h-100">
                      <Row className="g-0 h-100 align-items-start align-content-center">
