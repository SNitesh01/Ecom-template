      ...
      <div className="mb-5">
        ...
        <Card className="mb-2">
          <Card.Body>
            <Row className="g-0">
              <Col xs="auto">
                <img src="/img/brand/dhl.jpg" className="card-img rounded-md h-100 sh-6 sw-9" alt="thumb" />
              </Col>
              <Col className="ps-4">
                <Row className="mb-1">
                  <Col>
        ...
        <Card className="mb-2">
          <Card.Body>
            <Row className="g-0">
              <Col xs="auto">
                <img src="/img/brand/fedex.jpg" className="card-img rounded-md h-100 sh-6 sw-9" alt="thumb" />
              </Col>
              <Col className="ps-4">
                <Row className="mb-1">
                  <Col>
        ...
        <Card className="opacity-50">
          <Card.Body>
            <Row className="g-0">
              <Col xs="auto">
                <img src="/img/brand/ups.jpg" className="card-img rounded-md h-100 sh-6 sw-9" alt="thumb" />
              </Col>
              <Col className="ps-4">
                <Row className="mb-1">
                  <Col>
